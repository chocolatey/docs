---
Order: 50
xref: choco-command-template
Title: Template
Description: Template Command (choco template)
RedirectFrom:
  - docs/commandstemplate
...
> :choco-info: **NOTE**
>
> This documentation has been automatically generated from `choco template -h`. 
