---
Order: 60
xref: choco-command-convert
Title: Convert
Description: Convert Command (choco convert)
RedirectFrom:
  - docs/commandsconvert
  - docs/commands-convert
---
...
# Convert Command (choco convert)

### Package Converter

[Chocolatey for Business](https://chocolatey.org/compare) starting in version 3.0.0.

Converts a NuGet Package into an `intunewin` file to use with Microsoft Endpoint Manager.


## Usage

    choco convert <pkg> [<options/switches>]

## Examples

    choco convert sysinternals.nupkg --to-format=intune

    choco convert notepadplusplus.nupkg --to-format=intune
...
~~~
 ...
 -c, --cache, --cachelocation, --cache-location=VALUE
     ...
     Include all nupkg files in the working directory
...
> :memo: **NOTE** This documentation has been automatically generated from `choco convert -h`. 
