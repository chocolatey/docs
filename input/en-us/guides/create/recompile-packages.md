...
Internalizing a Chocolatey package at a high level involves:
 ...
 1. Downloading the resources the package has and putting them in the package or somewhere internal ([UNC, internal Http repository, DFS](../../features/how-to-host-feed), [SCCM Distribution point](../../features/infrastructure-automation), etc).
