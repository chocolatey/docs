...
- **New Commands:**
  ...
  1. `apikey` - see [ApiKey Command](xref:choco-command-setapikey)
  1. `new` - see [New Command](xref:choco-command-new) and [Chocolatey #157](https://github.com/chocolatey/chocolatey/issues/157)
