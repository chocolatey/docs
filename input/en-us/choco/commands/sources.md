...
**NOTE:** Mostly compatible with older chocolatey client (0.9.8.x and
 ...
 details, see [how to pass arguments](./#how-to-pass-options-switches) (`choco -?`).
