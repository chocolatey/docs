...
1. Download the script from [Exercise 4 here](./how-tos/setup-offline-installation#exercise-4-create-a-package-for-the-license), and save it in your `choco-setup\files` folder as `Add-LicensePackage.ps1`.
