...
**NOTE**: Package parameters can be passed as `--params`, but also as a few different ways including `--package-parameters`. See [install options](../usage/commands/install#options-and-switches):
