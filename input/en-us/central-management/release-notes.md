...
* Chocolatey for Business (C4B) customers - also refer to [Chocolatey Licensed Extension Release Notes](../licensed-extension/release-notes) and [Chocolatey Agent Release Notes](../chocolatey-agent/release-notes).
