...
You may want to setup the [automatic deletion of computers](xref:ccm-administration-settings-retention#stale-computer-deletion) that are no longer reporting into Chocolatey Central Management.
