...
the package means you don't need to manually install or upgrade the software directly on the machine. When combined with <Xref title="Chocolatey Central Management" value="central-management"/>, installing and upgrading your
