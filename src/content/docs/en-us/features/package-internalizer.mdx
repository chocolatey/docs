...
Unfortunately, not all packages on the Chocolatey Community Repository are created equal, even with the rigorous <Xref title="moderation process" value="moderation" />.
