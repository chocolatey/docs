...
![Chocolatey Architecture Diagram](https://img.chocolatey.org/docs/internalizer/architecture-diagram.png)
...
1. As the code we will be running in the Jenkins jobs is PowerShell, we need to add the PowerShell plugin.
   ...
   * Click **Manage Plugins**
   ...
   ![Jenkins PowerShell Plugin](https://img.chocolatey.org/docs/internalizer/jenkins-ps-plugin.png)
