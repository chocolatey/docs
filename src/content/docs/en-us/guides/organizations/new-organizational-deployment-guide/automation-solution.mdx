...
<TabsPaneContainer>
    <TabsPane content={automationpipeline[0]}>
        ...
        | Repository User Name | <DynamicCodeBlockInput name="OrgGuideRepoUserName" defaultValue="someUser" /> | The user for managing Chocolatey Packages on the repository. |
        ...
        | Repository API Key | <DynamicCodeBlockInput name="OrgGuideRepoUserApiKey" defaultValue="0057bf69-61af-4e86-b9a3-64521fc04722" /> | The API key for pushing Chocolatey packages to the repository. |
        | Thumbprint | <DynamicCodeBlockInput name="OrgGuideCertificateThumbprint" defaultValue="1234567890" /> | Optional: The certificate thumbprint to secure Jenkins with SSL. |
