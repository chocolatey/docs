...
<TabsPaneContainer>
    <TabsPane content={repository[0]}>
        ...
        | SSL Certificate Thumbprint | <DynamicCodeBlockInput name="CertificateThumbprint" defaultValue="1234567890" /> | The Thumbprint of your SSL certificate. |
        | Nexus Port Number | <DynamicCodeBlockInput name="NexusPortNumber" defaultValue="8443" /> | The port number you want to use for Nexus. |
        ...
        <details>
        <summary><strong>You must install the certificate to the Local Machine \ Trusted People store if providing the Thumbprint. (click to expand)</strong></summary>
