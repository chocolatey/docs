...
<TabsPaneContainer>
    <TabsPane content={repository[0]}>
        ...
        - Configure a Generic (Raw) repository for hosting large installation media and PowerShell scripts to onboard client workstations with Chocolatey for Business
