...
![Two screenshots showing the Internet Explorer settings for System Level Proxy configuration](https://img.chocolatey.org/docs/faqs/system-proxy-settings.png)
...
![Shows the encrypted proxy configuration information that is stored in the chocolatey.config file](https://img.chocolatey.org/docs/faqs/proxy-config-changes.png)
