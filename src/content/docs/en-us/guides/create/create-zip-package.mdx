...
### Using `Expand-ChocolateyArchive`

In our first example, we'll leverage <Xref title="`Expand-ChocolateyArchive`" value="expand-chocolateyarchive" /> to extract a Zip archive to disk. This function requires
...
Expand-ChocolateyArchive @unzipArgs
