...
- <Xref title="A supported version of Windows" value="chocolatey-products-dependencies-and-support-lifecycle" anchor="supported-windows-versions" />.
- <Xref title="A supported version of PowerShell" value="chocolatey-products-dependencies-and-support-lifecycle" anchor="supported-powershell-versions" />
...
* <Xref title="A supported PowerShell version" value="chocolatey-products-dependencies-and-support-lifecycle" anchor="supported-powershell-versions" />
* .NET Framework 4.5
