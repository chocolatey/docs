...
![install](https://img.chocolatey.org/docs/gifs/choco_install_pro.gif)
...
<Callout type="warning">
 ...
 1. That's it! You are good to go.
  ...
  ![license](https://img.chocolatey.org/docs/chocolatey/chocolatey-license.png)

  ![install/upgrade](https://img.chocolatey.org/docs/chocolatey/install-upgrade-chocolatey-extension.png)
