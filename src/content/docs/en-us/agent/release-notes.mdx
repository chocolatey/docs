...
- Provide ability to control number of retry attempts, or total duration for retry, to connect with Chocolatey Central Management.
  - See [#224](https://github.com/chocolatey/chocolatey-licensed-issues/issues/224).

## 4.0.0 (March 18, 2026) \{#v4.0.0}

<Callout type="warning">
    To provide the ability to report additional package information and to submit system facts to Chocolatey Central Management, Chocolatey Agent now requires Chocolatey CLI v2.7.0 and Chocolatey Licensesd Extension v8.0.0.
</Callout>
...
## 3.0.0 (December 1, 2025) \{#v3.0.0}

<Callout type="warning">
    To provide the ability to customize which command options should be blocked, Chocolatey Agent now requires Chocolatey Licensed Extension v7.0.0.
</Callout>
...
- Bump minimum Chocolatey Licensed Extension dependency version to 7.0.0.

### Bug Fix

- Fix Background Service not passing `--source` argument in recommended format.
...
- Fix - Deployments - Failing to load compiled PowerShell module on the second try
