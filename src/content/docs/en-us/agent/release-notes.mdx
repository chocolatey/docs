...
<Callout type="warning">
    To provide the ability to report additional package information and to submit system facts to Chocolatey Central Manager, Chocolatey Agent now requires Chocolatey CLI v2.7.0 and Chocolatey Licensesd Extension v8.0.0.
</Callout>
