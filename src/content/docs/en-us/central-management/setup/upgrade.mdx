...
import RestartCcmWebsite from '@components/docs/RestartCcmWebsite.mdx';
import RestartCcmWebsiteAndServices from '@components/docs/RestartCcmWebsiteAndServices.mdx';
...
Similar to how we internalized in <Xref title="Setup - Internalize Packages" value="ccm-setup" anchor="step-1-internalize-packages" />, we need to get the latest editions of everything compatible. Be sure that the versions of packages you have match up with the <Xref title="Compatibility Matrix" value="central-management" anchor="chocolatey-central-management-component-compatibility-matrix" />.
...
choco download dotnet-10.0-runtime dotnet-10.0-aspnetruntime dotnet-aspnetcoremodule-v2 --source="'https://community.chocolatey.org/api/v2/'" --internalize --output-directory="'C:\packages'"
...
## Step 3: Upgrade Central Management Windows Service(s)
...
## Step 4: Upgrade Central Management Website
