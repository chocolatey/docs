...
Reports can be exported from this screen via the <i class="fa-solid fa-gear" aria-hidden="true"></i> **Actions** menu, and selecting the desired export type.
...
When clicking on the date and time for a report, or selecting the <i class="fa-solid fa-gear" aria-hidden="true"></i> **Actions** menu and then **Details**, the Outdated Software Details screen will be shown.
...
The Outdated Software Report currently being viewed can be exported from this screen via the <i class="fa-solid fa-download" aria-hidden="true"></i> **Export** menu at the top-right.

![Outdated Software Details view, showing the Export to PDF menu option](/images/ccm-playwright/reports/outdated-software/details/button-action-dropdown-menu-export-to-pdf.png)

![Outdated Software Details view, showing the Export to Excel menu option](/images/ccm-playwright/reports/outdated-software/details/button-action-dropdown-menu-export-to-excel.png)
...
![Deployment Plans report page](/images/ccm-playwright/deployment-plans/completed/screen.png)
