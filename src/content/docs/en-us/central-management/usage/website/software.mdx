...
In the leftmost column of the Software table you will find an <i class="fa-solid fa-gear" aria-hidden="true"></i> **Actions** menu which will display an **Upgrade** option on outdated Software.
...
In the leftmost column of the Software table you will find an <i class="fa-solid fa-gear" aria-hidden="true"></i> **Actions** menu which will display an **Uninstall** option.
...
In the leftmost column of the Software table you will find an <i class="fa-solid fa-gear" aria-hidden="true"></i> **Actions** menu which will display a **Details** option.
