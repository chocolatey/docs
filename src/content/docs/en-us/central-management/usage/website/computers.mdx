...
![Computers menu entry on the Chocolatey Central Management Dashboard](https://img.chocolatey.org/docs/ccm-playwright/dashboard/left-menu-computers.png)
...
![Finding a computer's details menu option](https://img.chocolatey.org/docs/ccm-playwright/computers/table-row-button-action-dropdown-menu-details.png)

On selecting the **Software** tab, you will be presented with a list of the installed software packages for the machine, similar to below.

![Computer details screen showing installed software](https://img.chocolatey.org/docs/ccm-playwright/computers/details/tab-software.png)

## Viewing Facts Collected for a Computer

<callout type="info">
    Starting with Chocolatey Central Management 0.15.0, additional information about computers will be displayed on their Details screens if it is available in the form of **Facts**.
    This information is collected periodically from computers starting with Chocolatey Agent v4.0.0, and will not be available for computers on earlier versions of Chocolatey Agent.
</callout>

From the Computer Details page, selecting the **Facts** tab will display the available facts about a computer.

![Computer details screen showing available Facts](https://img.chocolatey.org/docs/ccm-playwright/computers/details/tab-facts.png)
...
1. In the leftmost column of the Computer table you will find an **Actions** button which will display a **Create Deployment Plan** option.
    ...
    ![Finding the Create Deployment Plan menu entry for a specific Computer on the Computers page](https://img.chocolatey.org/docs/ccm-playwright/computers/table-row-button-action-dropdown-menu-create-deployment-plan.png)

1. From the Computer Details page, click the **Actions for Computer** button and select the **Create Deployment Plan** option.

    ![Button to create a new draft Deployment Plan from the Computer Details page](https://img.chocolatey.org/docs/ccm-playwright/computers/details/button-action-dropdown-menu-create-deployment-plan.png)
...
![Automatically created Deployment Plan showing the Deployment Step modal script command area](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/edit/computers-modal-new-deployment-plan.png)
...
![Warning button on Deployment Step with ineligible deployment message](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/edit/popover-ineligible-step.png)
...
1. In the leftmost column of the Computer table you will find an **Actions** button which will display a **Upgrade Outdated Software** option.
    ...
    ![Finding the Upgrade Outdated Software menu entry for a specific Computer on the Computers page](https://img.chocolatey.org/docs/ccm-playwright/computers/table-row-button-action-dropdown-menu-upgrade-outdated-software.png)

1. From the Computer Details page, click the **Actions for Computer** button and select the **Upgrade Outdated Software** option.

    ![Button to create a new Deployment Plan to upgrade all outdated Software on a Computer from the Computer Details page](https://img.chocolatey.org/docs/ccm-playwright/computers/details/button-action-dropdown-menu-upgrade-outdated-software.png)
...
![Automatically created Deployment Plan showing Deployment Steps](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/edit/computers-upgrade-outdated-software.png)
...
![Computer details screen highlighting Export to packages.config button](https://img.chocolatey.org/docs/ccm-playwright/computers/details/button-action-dropdown-menu-export-to-packages.config.png)
...
![Deleting a computer in Central Management](https://img.chocolatey.org/docs/ccm-playwright/administration/roles/table-row-button-action-dropdown-menu-delete.png)
