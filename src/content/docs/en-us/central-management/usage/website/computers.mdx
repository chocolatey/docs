...
1. In the leftmost column of the Computer table you will find an **Actions** button which will display a **Create New Deployment Plan** option.
...
1. From the Computer Details page, click the **Actions for Computer** button and select the **Create New Deployment Plan** option.
