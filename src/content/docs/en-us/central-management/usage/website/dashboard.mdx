...
![Dashboard page for Chocolatey Central Management showing available KPI's and last updated time](https://img.chocolatey.org/docs/ccm-playwright/dashboard/left-menu-dashboard.png)