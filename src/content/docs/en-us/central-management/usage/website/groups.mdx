...
On the main Groups page, select the **Actions for Groups** button and selecting the **Create New Group** menu option.
...
1. In the leftmost column of the Groups table you will find an **Actions** button which will display a **Create New Deployment Plan** option.
...
1. From the Group Details page, click the **Actions for Group** button and select the **Create New Deployment Plan** option.
