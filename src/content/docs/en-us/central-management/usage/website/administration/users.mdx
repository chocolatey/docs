...
![Users menu entry on the Chocolatey Central Management Dashboard](https://img.chocolatey.org/docs/ccm-playwright/dashboard/left-menu-users.png)
...
![Chocolatey Central Management dashboard, arrow pointing to the Create User menu option in the left sidebar](https://img.chocolatey.org/docs/ccm-playwright/dashboard/left-menu-create-user.png)
...
![Creating New User Setting User Properties](https://img.chocolatey.org/docs/ccm-playwright/administration/users/modal-new-user-tab-information.png)
...
![Creating New User Setting Roles](https://img.chocolatey.org/docs/ccm-playwright/administration/users/modal-new-user-tab-roles.png)
...
![Edit menu entry in User actions flyout menu](https://img.chocolatey.org/docs/ccm-playwright/administration/users/table-row-button-action-dropdown-menu-edit.png)
...
<Callout type="info">
    If <Xref title="LDAP group mapping" value="ccm-administration-settings-user-management" anchor="mapping-ldap-groups-to-roles" /> is enabled, the Roles of an LDAP user are managed by their LDAP groups and are recalculated on every login. Any Role selections you make when editing an LDAP user is ignored, both in this modal and through the API, so their Roles cannot be changed here. Update the user's LDAP group membership, or the <Xref title="group-to-Role mapping" value="ccm-administration-roles" anchor="ldap-group-mapping" />, instead.
</Callout>
...
![Permissions menu entry in User actions flyout menu](https://img.chocolatey.org/docs/ccm-playwright/administration/users/modal-permissions.png)
