...
![Audit Retention Settings](https://img.chocolatey.org/docs/ccm-playwright/administration/settings/retention-policies-checkbox-enable-audit-retention.png)
...
![Stale Computer Deletion Settings](https://img.chocolatey.org/docs/ccm-playwright/administration/settings/retention-policies-checkbox-enable-stale-computer-retention.png)
...
![Deployment Plan Retention Settings](https://img.chocolatey.org/docs/ccm-playwright/administration/settings/retention-policies-checkbox-enable-deployment-plan-retention.png)
