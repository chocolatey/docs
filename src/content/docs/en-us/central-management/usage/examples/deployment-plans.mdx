...
- Click the **Actions** button and select the **Edit** option on the preferred Deployment Step.
    ...
    ![Editing a Deployment Step](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/edit/table-row-button-action-dropdown-menu-edit.png)
...
- Select preferred Groups by checking each checkbox in the table. You can also select the top left checkbox in the table head to immediately add all Groups.
    ...
    ![Selecting Target Groups](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/edit/modal-step-select-target-groups.png)
...
![Updating an invalid Start Date Time](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/edit/calendar-start-date-time.png)
