...
```markup
The timezone specified in your user account was invalid and it has been set to UTC.
```
...
```markup
The timezone specified on the 'General Settings' page was invalid and it has been set to UTC.
```
