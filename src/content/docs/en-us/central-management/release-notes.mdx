...
## -.15.0 (March 18, 2026) \{#v0.15.0}

### Enhancements

- Display and allow API querying of facts gathered from client computers - see [#1075](https://gitlab.com/chocolatey/central-management/choco-licensed-management-ui/-/work_items/1075).
- Automate linking to a GitHub branch - see [#1106](https://gitlab.com/chocolatey/central-management/choco-licensed-management-ui/-/work_items/1106).
- Display all package related information in Computer and Software screens. - see [#1122](https://gitlab.com/chocolatey/central-management/choco-licensed-management-ui/-/work_items/1122).
