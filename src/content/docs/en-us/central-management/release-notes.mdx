...
<Callout type="warning">
    ...
    [Further information about this change can be found in our blog post](https://blog.chocolatey.org/2026/07/announcing-ccm-release-0.17.0/).
</Callout>

<Callout type="warning">
    The Chocolatey Central Management Site will _only_ work correctly when the website uses an SSL certificate.
</Callout>

### Breaking Changes

- Add support for .NET 10.0 to all Chocolatey Central Management components.
