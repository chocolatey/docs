...
<Callout type="info">
    In order to provide _all_ the functionality of Chocolatey Central Management, for example, the gathering of facts by Chocolatey Agent, the following product versions should be used.
</Callout>

|Chocolatey Central Management|Chocolatey Agent|Chocolatey Licensed Extension|Chocolatey|
|-----------------------------|----------------|-----------------------------|----------|
|0.17.0                       |4.0.0+          | 8.0.0+                      | 2.7.0+   |
