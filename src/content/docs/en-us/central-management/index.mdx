...
<div class="row mb-3">
    <div class="col-sm-6 mb-3 mb-sm-0">
        <img src="/images/ccm-playwright/dashboard/light-mode.png" alt="Chocolatey Central Management Dashboard in light mode" />
    </div>
    <div class="col-sm-6">
        <img src="/images/ccm-playwright/dashboard/dark-mode.png" alt="Chocolatey Central Management Dashboard in dark mode" />
    </div>
</div>
