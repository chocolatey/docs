...
- Chocolatey GUI Licensed Extension is not available in Chocolatey GUI.

## 2.0.1 (December 1, 2025) \{#v2.0.1}

<Callout type="warning">
    There is a bug in Chocolatey GUI Licensed Extension that prevents it from being loaded when Chocolatey GUI is launched, causing Business features to not be available.
    The package version has been pulled from the Chocolatey Licensed Feed, but these release notes have been kept for historical reasons.

    This bug has been fixed in version 2.0.2 of Chocolatey GUI Licensed Extension.
</Callout>

Read our [blog post](https://blog.chocolatey.org/2025/12/announcing-cle-260-cle-700-agent-300-releases/) about this release.

### Enhancement

- Increase maximum version range for `chocolatey.extension` dependency.
