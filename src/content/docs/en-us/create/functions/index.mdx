...
These functions call other functions and many times may be the only thing you need in your <Xref title="chocolateyInstall.ps1 file" value="package-scripts" />.
