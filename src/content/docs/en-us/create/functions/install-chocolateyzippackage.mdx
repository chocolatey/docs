...
Expand-ChocolateyArchive when local or embedded file.
...
to download a file first), use Expand-ChocolateyArchive instead.
 ...
 * <Xref title='Expand-ChocolateyArchive' value='expand-chocolateyarchive' />
