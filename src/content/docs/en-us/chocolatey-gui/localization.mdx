...
Once you have an account, you will be able to request to join the [Chocolatey GUI](https://app.transifex.com/chocolatey/chocolatey-gui/dashboard/) project in transifex.
...
This can be done via the [Chocolatey GUI dashboard](https://app.transifex.com/chocolatey/chocolatey-gui/dashboard/).
