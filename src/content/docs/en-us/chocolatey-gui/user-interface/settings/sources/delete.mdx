...
![Showing the user interface when removing a source](https://img.chocolatey.org/docs/chocolatey-gui/user_interface_settings_sources_remove.png "Showing the user interface when removing a source")
