...
![Showing the Sources screen within settings](https://img.chocolatey.org/docs/chocolatey-gui/user_interface_settings_sources.png "Showing the Sources screen within settings")