...
![Showing the user interface when editing an existing source](https://img.chocolatey.org/docs/chocolatey-gui/user_interface_settings_sources_edit_1.png "Showing the user interface when editing an existing source")
...
<Callout type="info">
    ...
    ![Showing the user interface when attempting to edit chocolatey.licensed source](https://img.chocolatey.org/docs/chocolatey-gui/user_interface_settings_sources_edit_2.png "Showing the user interface when attempting to edit chocolatey.licensed source")
</Callout>
