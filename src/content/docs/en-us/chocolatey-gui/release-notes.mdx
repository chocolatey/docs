...
- Move images to shared repository and update URLs.
  - See [#1094](https://github.com/chocolatey/ChocolateyGUI/issues/1094) by [alexaveldanez](https://github.com/alexaveldanez), resolved in [!1095](https://github.com/chocolatey/ChocolateyGUI/pull/1095) by [alexaveldanez](https://github.com/alexaveldanez).
