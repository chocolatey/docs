...
## 0.21.1 (February 6, 2026) \{#v0.22.1}

### Bug Fix

- ArtifactBase has a required namechange - see [#174](https://github.com/chocolatey/c4b-azure/issues/174).

### Improvement

- Update Chocolatey Package & Jenkins Plugin Versions - see [#172](https://github.com/chocolatey/c4b-azure/issues/172).
...
|----------------------------|---------------|
| chocolatey                 | 2.6.0         |
| chocolatey-agent           | 3.0.0         |
| chocolatey.extension       | 7.0.0         |
| chocolateygui.extension    | 2.0.2         |
| dotnet-8.0-aspnetruntime   | 8.0.23        |
| dotnet-8.0-runtime         | 8.0.23        |
| dotnet-aspnetcoremodule-v2 | 18.0.25343    |
| jenkins                    | 2.541.1       |
| nexus-repository           | 3.71.0.601    |
| Temurin21jre               | 21.0.9.10     |
| vcredist140                | 14.44.35211   |

## 0.22.0 (June 3, 2025) \{#v0.22.0}

### Bug Fix

- Chocolatey 2.4.1 breaks Jenkins jobs - see [#167](https://github.com/chocolatey/c4b-azure/issues/167).

### Improvements

- Storage Account(s) should be restricted to secure transfer only - see [#157](https://github.com/chocolatey/c4b-azure/issues/157).
- SQL Server should be running TLS 1.2+ - see [#159](https://github.com/chocolatey/c4b-azure/issues/159).
- Image SKU should be updated to Windows Server 2022 - see [#165](https://github.com/chocolatey/c4b-azure/issues/165).
- ClientSetup Enhancements - see [#166](https://github.com/chocolatey/c4b-azure/issues/166).
...
| chocolatey-licensed-jenkins-jobs    | 0.1.3 (New)   |
| chocolatey-licensed-jenkins-scripts | 0.1.3         |
| chocolatey-management-database      | 0.14.0        |
| chocolatey-management-service       | 0.14.0        |
| chocolatey-management-web           | 0.14.0        |
| chocolatey.extension                | 6.3.1         |
| chocolateygui                       | 2.1.1         |
| dotnet-6.0-aspnetruntime            | N/A (Removed) |
| dotnet-6.0-runtime                  | N/A (Removed) |
| dotnet-8.0-aspnetruntime            | 8.0.16 (New)  |
| dotnet-8.0-runtime                  | 8.0.16 (New)  |
| dotnet-aspnetcoremodule-v2          | 18.0.25074    |
| jenkins                             | 2.504.2       |
| jenkins-set-prefix.hook             | 1.0.1         |
| KB3063858                           | N/A (Removed) |
| nexus-repository                    | 3.71.0.6      |
| nexushell                           | 1.2.0 (New)   |
| Temurin21jre                        | 21.0.6.7      |
