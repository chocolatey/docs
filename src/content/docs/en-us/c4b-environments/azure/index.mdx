...
![Resource Group Selector](https://img.chocolatey.org/docs/c4b/BasicsView-ResourceGroupSelector.png)
...
![Naming Prefix](https://img.chocolatey.org/docs/c4b/BasicsView-InstanceDetails.png)
...
![License Upload](https://img.chocolatey.org/docs/c4b/BasicsView-LicenseUpload.png)
...
![Custom Domain Configuration](https://img.chocolatey.org/docs/c4b/DomainView-CustomDomain.png)
...
![Package Internalization Screen](https://img.chocolatey.org/docs/c4b/InternalizePackagesView.png)
...
![Public IP Address](https://img.chocolatey.org/docs/c4b/PublicIPAddress-EssentialsView.png)
...
1. Click `+ Add Access Policy`
    ...
    ![Vault Access Policies](https://img.chocolatey.org/docs/c4b/KeyVault-AccessPolicies.png)

1. Select, at a minimum, `Secret Permissions`: `Get` and `List` *(You can use a Template such as `Secret Management`)*

    ![Secret Permissions](https://img.chocolatey.org/docs/c4b/KeyVault-SecretPermissions.png)

1. Under `Select Principal`, click `None Selected` and find your current user, and select it
1. Click `Add`

    ![Add Principal](https://img.chocolatey.org/docs/c4b/KeyVault-AddPrincipal.png)
...
![Secrets in Vault](https://img.chocolatey.org/docs/c4b/KeyVault-Secrets.png)
...
1. Click the green "play" triangle to the right of the `Internalize packages from the Chocolatey Community and Licensed Repositories` job
    ...
    ![Location of Jenkins job play button](https://img.chocolatey.org/docs/c4b/Jenkins-Play-Button.png)
...
1. Click `Build`
    ...
    ![Example of settings for the Internalize Packages Jenkins job](https://img.chocolatey.org/docs/c4b/Jenkins-Job-Fix-Internalize.png)
