...
![Reject package checkbox is only visible if the package has failed automated review](https://img.chocolatey.org/docs/faqs/package-moderation-reject-package.png)

* Failing verification -

![An example email which is sent to maintainer of package when an automated check has failed](https://img.chocolatey.org/docs/faqs/email-from-validator.png)
...
![Passing verification](https://img.chocolatey.org/docs/faqs/verification-successful.png)
