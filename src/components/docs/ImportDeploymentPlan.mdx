...
1. From the Chocolatey Central Management dashboard, select **Deployment Plans** from the left sidebar and select the **Import Deployment Plans** option
    ...
    ![Chocolatey Central Management dashboard, arrow pointing to the Import Deployment Plan menu option in the left sidebar](https://img.chocolatey.org/docs/ccm-playwright/dashboard/left-menu-import-deployment-plan.png)
...
1. Click the **Choose File** button to select your `.json` file. Review the imported Deployment Plan and then click the **Import** button.
    ...
    ![Chocolatey Central Management import Deployment Plan modal, arrow pointing to the Choose Deployment Plan button and the Import button](https://img.chocolatey.org/docs/ccm-playwright/deployment-plans/modal-import-deployment-plan.png)
